...
idx <- c(idx$sample, "EB_KDR_HET_1", "EB_KDR_HOM_2")
```
...
mnn$source[mnn$batch == "EB_KDR_HET_1"] <- "embryo"

mnn$source[mnn$batch == "EB_KDR_HOM_2"] <- "embryo"
```
...
mnn$genotype[mnn$batch == "EB_KDR_HET_1"] <- "het"

mnn$genotype[mnn$batch == "EB_KDR_HOM_2"] <- "hom"
```
